...
class Fusion:
    ...
    def download(  # noqa: PLR0912, PLR0913
        ...
        dataset: str,
        dt_str: str = "latest",
        dataset_format: Optional[str] = "parquet",
        catalog: Optional[str] = None,
    ...
    def list_product_dataset_mapping(
        ...
        Args:
            dataset (str | list[str] , optional): A string or list of strings that are dataset
            ...
            product (str | list[str] , optional): A string or list of strings that are product
            identifiers to filter the output. If a list is provided then it will return
            products whose identifier matches any of the strings. Defaults to None.
            catalog (str , optional): A catalog identifier. Defaults to 'common'.
    ...
    def product(  # noqa: PLR0913
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            category (str | list[str] , optional): Category. Defaults to None.
            ...
            is_restricted (bool , optional): Flag for restricted products. Defaults to None.
            maintainer (str | list[str] , optional): Product maintainer. Defaults to None.
            region (str | list[str] , optional): Product region. Defaults to None.
            publisher (str , optional): Name of vendor that publishes the data. Defaults to None.
            sub_category (str | list[str] , optional): Product sub-category. Defaults to None.
            tag (str | list[str] , optional): Tags used for search purposes. Defaults to None.
            delivery_channel (str | list[str], optional): Product delivery channel. Defaults to "API".
            theme (str , optional): Product theme. Defaults to None.
            release_date (str , optional): Product release date. Defaults to None.
            ...
            dataset (str | list[str] , optional): Product datasets. Defaults to None.
    ...
    def dataset(  # noqa: PLR0913
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            category (str | list[str] , optional): A category or list of categories for the dataset.
            Defaults to None.
            ...
            is_restricted (bool , optional): Flag for restricted datasets. Defaults to None.
            is_raw_data (bool, optional): Flag for raw datasets. Defaults to True.
            maintainer (str , optional): Dataset maintainer. Defaults to "J.P. Morgan Fusion".
            source (str | list[str] , optional): Name of data vendor which provided the data. Defaults to None.
            region (str | list[str] , optional): Region. Defaults to None.
            publisher (str, optional): Name of vendor that publishes the data. Defaults to "J.P. Morgan".
            product (str | list[str] , optional): Product to associate dataset with. Defaults to None.
            sub_category (str | list[str] , optional): Sub-category. Defaults to None.
            tags (str | list[str] , optional): Tags used for search purposes. Defaults to None.
            created_date (str , optional): Created date. Defaults to None.
            modified_date (str , optional): Modified date. Defaults to None.
            ...
            type_ (str , optional): Dataset type. Defaults to "Source".
            container_type (str , optional): Container type. Defaults to "Snapshot-Full".
            snowflake (str , optional): Snowflake account connection. Defaults to None.
            complexity (str , optional): Complexity. Defaults to None.
            is_immutable (bool , optional): Flag for immutable datasets. Defaults to None.
            is_mnpi (bool , optional): is_mnpi. Defaults to None.
            is_pci (bool , optional): is_pci. Defaults to None.
            is_pii (bool , optional): is_pii. Defaults to None.
            is_client (bool , optional): is_client. Defaults to None.
            is_public (bool , optional): is_public. Defaults to None.
            is_internal (bool , optional): is_internal. Defaults to None.
            is_confidential (bool , optional): is_confidential. Defaults to None.
            is_highly_confidential (bool , optional): is_highly_confidential. Defaults to None.
            is_active (bool , optional): is_active. Defaults to None.
            owners (list[str] , optional): The owners of the dataset. Defaults to None.
            application_id (str , optional): The application ID of the dataset. Defaults to None.
    ...
    def attribute(  # noqa: PLR0913
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            source (str , optional): Name of data vendor which provided the data. Defaults to None.
            source_field_id (str , optional): Original identifier of attribute, if attribute has been renamed.
                If not provided, defaults to identifier.
            is_internal_dataset_key (bool , optional): Flag for internal primary keys. Defaults to None.
            is_externally_visible (bool , optional): Flag for externally visible attributes. Defaults to True.
            unit (Any , optional): Unit of attribute. Defaults to None.
            multiplier (float, optional): Multiplier for unit. Defaults to 1.0.
            is_propagation_eligible (bool , optional): Flag for propagation eligibility. Defaults to None.
            is_metric (bool , optional): Flag for attributes that are metrics. Defaults to None.
            available_from (str , optional): Date from which the attribute is available. Defaults to None.
            deprecated_from (str , optional): Date from which the attribute is deprecated. Defaults to None.
            term (str, optional): Term. Defaults to "bizterm1".
            dataset (int , optional): Dataset. Defaults to None.
            attribute_type (str , optional): Attribute type. Defaults to None.
    ...
    def attributes(
        ...
        Args:
            attributes (list[Attribute] , optional): List of Attribute objects. Defaults to None.
    ...
    def input_dataflow(  # noqa: PLR0913
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            language (str, optional): Language. Defaults to "English".
            status (str, optional): Status. Defaults to "Available".
            type_ (str , optional): Dataset type. Defaults to "Flow".
            container_type (str , optional): Container type. Defaults to "Snapshot-Full".
            snowflake (str , optional): Snowflake account connection. Defaults to None.
            complexity (str , optional): Complexity. Defaults to None.
            is_immutable (bool , optional): Flag for immutable datasets. Defaults to None.
            ...
            owners (list[str] , optional): The owners of the dataset. Defaults to None.
            application_id (str , optional): The application ID of the dataset. Defaults to None.
            producer_application_id (dict[str, str] , optional): The producer application ID (upstream application
                producing the flow).
            consumer_application_id (list[dict[str, str]] | dict[str, str] , optional): The consumer application
                ID (downstream application, consuming the flow).
            flow_details (dict[str, str] , optional): The flow details. Specifies input versus output flow.
    ...
    def list_indexes(
        ...
        Args:
            ...
            catalog (str , optional): A catalog identifier. Defaults to 'common'.
            show_details (bool , optional): If True then show detailed information. Defaults to False.
    ...
    def get_async_fusion_vector_store_client(self, knowledge_base: str, catalog: Optional[str] = None) -> AsyncOpenSearch:
        """Returns Fusion Embeddings Search client.
